...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Linear Regression/Linear Regression BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ARIMA/ARIMA BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/RNN/RNN BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/GRU/GRU BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/LSTM/LSTM BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/Holt Winters/Holt Winters BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES ETH_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/SES/SES BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN ETH_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN ETH_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN BNB_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN BNB_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN BNB_USDT Price Prediction 9-1.png}
    \end{minipage}
    \centering
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN BTC_USDT Price Prediction 7-3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN BTC_USDT Price Prediction 8-2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.15\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{bibliography/ResCNN/ResCNN BTC_USDT Price Prediction 9-1.png}
    \end{minipage}
